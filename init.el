...
(use-package angular-mode
  :ensure t
  :init
  (add-to-list 'auto-mode-alist '("\\page.html\\'" . angular-html-mode))
  (add-to-list 'auto-mode-alist '("\\component.html\\'" . angular-html-mode)))
;;; End Angular
