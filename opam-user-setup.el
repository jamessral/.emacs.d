...
;; ## added by OPAM user-setup for emacs / tuareg ## b85cd40423d4e013f322ec602fbbb592 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/Users/jamessral/.opam/4.04.1/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 92faeec5cc1a052ca879e8eccb315abd ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/jamessral/.opam/4.04.1/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/jamessral/.opam/4.04.1/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/jamessral/.opam/4.04.1/bin/ocp-indent"))
